...
import com.example.sellerapp.domain.usecase.GetAuthKeyUseCase
...
class OnBoardingViewModel @Inject constructor(
    ...
    val imageLoader: ImageLoader): MviViewModel<OnBoardingViewState, OnBoardingEvent, OnBoardingEffect>() {
